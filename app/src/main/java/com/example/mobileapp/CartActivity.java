...
import com.example.mobileapp.databinding.ActivityCartBinding;
...
public class CartActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_home) {
            Intent intent = new Intent(CartActivity.this, ScrollingActivity.class);
            startActivity(intent);
            return true;
        }
        if (id == R.id.action_produkt) {
            Intent intent = new Intent(CartActivity.this, ProduktActivity.class);
            startActivity(intent);
            return true;
        }
