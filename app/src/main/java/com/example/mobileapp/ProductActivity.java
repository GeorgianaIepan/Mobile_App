...
import com.example.mobileapp.databinding.ActivityProductBinding;
...
public class ProductActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_home) {
            Intent intent = new Intent(ProductActivity.this, ScrollingActivity.class);
        ...
        if (id == R.id.action_my_account) {
            Intent intent = new Intent(ProductActivity.this, MyAccountActivity.class);
            startActivity(intent);
            return true;
        }
